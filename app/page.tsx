...
export default function Home(){
 ...
 return <main className="home-page">
  <section className="draft-hero" aria-labelledby="hero-title"><img src="/images/insurance-hero.png" alt="เอกสารประกันและแล็ปท็อปบนโต๊ะทำงาน" fetchPriority="high"/><h1 id="hero-title">เลือกประกันที่ใช่<br/><span>สำหรับคุณ</span></h1><Link href="/chat?start=1" className="hero-action">ค้นหาประกัน</Link></section>
