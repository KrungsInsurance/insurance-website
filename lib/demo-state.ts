...
export function chatRequestBody(history:DemoState["messages"],context:{category:CustomerProfile["preferredCategory"];selectedPlanIds:string[];budgetTHB:number|null;goals:string[];customerFacts?:CustomerFacts}):string{
